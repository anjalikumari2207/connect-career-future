...
const ADMIN_WALLET = "2FZezEYxMZ7SyVHeqv93KN4QbpWLhzEab7EZf5czqLVx"; // 🪙 Replace with your actual Solana wallet
const SOLANA_NETWORK = "devnet"; // 🌐 using Devnet
...
const PostJob = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const recipient = new PublicKey(ADMIN_WALLET);
    ...
    <div className="py-16 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">Pay with Phantom & post securely on Solana</p>
        </div>
