  ...
  const handleConnectWallet = async () => {
    try {
      ...
      if (typeof window !== 'undefined' && (window as any).ethereum) {
        ...
        const demoAddress = "0x742d35Cc6cF1F35d20F2c7Ff8C46E8CfF4c12345";
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Receive payments instantly without waiting for bank transfers</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">All transactions are recorded on the blockchain for transparency</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Work with clients worldwide without currency conversion hassles</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Reduced transaction fees compared to traditional payment processors</p>
                </div>
              </div>
            </CardContent>
          </Card>
