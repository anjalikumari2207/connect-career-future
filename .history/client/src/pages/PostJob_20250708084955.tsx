...
import { ethers } from "ethers"; // ✅ added for blockchain transaction

const ADMIN_WALLET = "0xb40dfB28A1D92f60b9eEe20A764E572eef728ACb"; // 🔁 Replace this with your actual wallet
...
console.log("🔗 Wallet address:", walletAddress);
    ...
    try {
      ...
      toast({ title: "Confirm payment to post job..." });

      const tx = await signer.sendTransaction({
        to: ADMIN_WALLET,
        value: ethers.parseEther("0.001"), // 💰 fee amount
      });
