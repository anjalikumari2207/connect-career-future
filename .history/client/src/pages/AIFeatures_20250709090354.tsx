...
const AIFeatures = () => {
  ...
  const handleJobMatch = async () => {
    ...
    try {
      const res = await axios.post<MatchResponse>("/ai/match-jobs", { text: skillText });
      ...
      toast({
        ...
        description: "Could not match jobs. Try again later.",
        variant: "destructive",
      });
    } finally {
      setIsAnalyzing(false);
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <Card className="border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>
                AI analyzes your resume to find best job matches
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {matchedJobs.length > 0 ? (
                ...
                <p className="text-sm text-gray-500">Paste resume and click Match Jobs to see results.</p>
              )}
            </CardContent>
          </Card>
        </div>
